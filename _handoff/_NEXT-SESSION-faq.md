...
- **Re-seeded answer-first** from `mari-core` — `_scripts/seed-faq.ts`, idempotent, safe to re-run.
...
- **⭐ Adinda's Studio review of FAQ v2** — not yet done. What to look at: `_QA-CHECKLIST.md` (incl. mobile).
- **⚠️ Commercial figures unverified** — the General FAQ answers quote deposit/cancellation/park+fuel fees/
  ...
  2026-06-09). **Verify with Serge before launch.** Detail: `_CONTENT-STATUS.md`.
...
- **`drk-website`** — 2 new items: the "Feature on homepage" pattern + its decision rule, and GROQ `+`
  null-poisoning. See `_handoff/drk-website.md`.
