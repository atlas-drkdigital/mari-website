# _POLISH-BACKLOG.md — deferred frontend polish, tracked page by page

Companion to `_SCHEMA-SPECS.md` (field approval), `_CONTENT-STATUS.md` (real vs. placeholder content),
and `_QA-CHECKLIST.md` (external-reviewer open decisions). This one exists so the **vertical-slice** build
...
built and reviewed. Full diagnosis for each lives in `_CONTENT-STATUS.md`; this is the burn-down list.
