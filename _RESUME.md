...
3. **🔵 THEN the `_internal/` root-cleanup refactor — BEFORE starting any other page.** Full spec:
...
- Skills handoff round: ~1,500+ lines in `_handoff/` and growing (now includes deployment-boundary
