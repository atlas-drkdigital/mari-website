    ...
    >
      ...
      <div className="hidden lg:block">
        ...
        <nav aria-label="Primary" className="flex items-center justify-center gap-32 border-b-[0.25px] border-transparent page-gutter-x py-12 group-data-[nav=mega]/nav:border-accent-ondark-onprimary">
          ...
          <a href="#the-boat" className="pb-4 text-nav uppercase opacity-85 transition-opacity duration-300 ease-in-out hover:opacity-100">The Boat</a>
      ...
      >
        ...
        <nav aria-label="Primary" className="flex flex-col page-gutter-x">
          ...
          <a href="#the-boat" onClick={() => setMobileMenuOpen(false)} className="border-b-[0.25px] border-accent-ondark-onprimary/15 py-16 text-nav uppercase text-text-ondark-primary opacity-85 transition-opacity duration-300 ease-in-out hover:opacity-100">The Boat</a>
