...
// gallery"). Run:
//   npx sanity exec _scripts/restore-section-headings.ts --with-user-token
//
// Values recovered from Sanity's history API at 2026-07-20T05:00:00Z (see _scripts/history-peek.ts),
