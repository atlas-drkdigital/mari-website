...
// Applies the APPROVED boat-page copy from _content/_boat.md to Sanity (2026-07-20). Run:
//   npx sanity exec _scripts/seed-boat-content.ts --with-user-token
//
...
//
// Source of truth is _content/_boat.md, which carries Adinda's approval. Copy is NOT reworded here;
