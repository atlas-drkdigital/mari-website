...
//   npx sanity exec _scripts/seed-layout-diagram.ts --with-user-token
//
...
async function run() {
  ...
  const diagram = {
    ...
    _type: 'object',
    heading: 'Deck plan',
    // Copy is deliberately factual and drawn only from figures already approved in _content/_boat.md
