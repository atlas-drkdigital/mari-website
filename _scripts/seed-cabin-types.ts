...
// no Deluxe per-cabin max at all. Flagged for Serge. Tracked in _CONTENT-STATUS.md.
//
...
// _CONTENT-STATUS.md instead. Do NOT stuff the note into `alt`: alt is read aloud to screen readers
