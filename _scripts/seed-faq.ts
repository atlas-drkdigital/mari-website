...
// Run: npx sanity exec _scripts/seed-faq.ts --with-user-token
//
...
// detail) per the FAQ SEO/AEO decision record in _SCHEMA-SPECS.md.
...
// decision in the destination-page slice (see _QA-CHECKLIST.md) — deleting it there is a one-item edit.
