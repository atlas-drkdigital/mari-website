# _internal/PAGE-SPECS.md — Adinda's section-by-section specs for the remaining pages (dictated 2026-07-23)
...
`_internal/handoff/atlas-website.md`; FAQ page / blog list / blog post / simple page (DRK-standard) →
`_internal/handoff/drk-website.md`. This file keeps the Mari build detail + open questions.
