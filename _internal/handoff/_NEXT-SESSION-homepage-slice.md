...
1. **Load skills:** `mari-project`, `drk-website`, `atlas-website`, `mari-core`, `mari-website`. Read
   `CLAUDE.md`, the top of `MANAGER.md`, and `_internal/handoff/*.md`.
...
destination). Update `_internal/CONTENT-STATUS.md`/seed as needed.
...
- **Guardrail:** build "functional, matches the built page" — defer cosmetic polish to `_internal/POLISH-BACKLOG.md`.
