...
`drk-website`/`atlas-website`/`mari-project`, see `_internal/handoff/drk-website.md` for the full explanation).
...
management, contracts, or design decisions (those are `mari-project`'s job — see `_internal/handoff/mari-project.md`
...
`_internal/CONTENT-STATUS.md` (L177, L206), `_internal/handoff/mari-website.md` (L81). Low-stakes but actively misleading:
...
`_internal/handoff/mari-core.md` was retired 2026-07-21 and this is the only surviving pointer to them.
...
`_internal/handoff/figma.md`). Real sections: Hero `778:8706` (sub-nav `Block/SubNav` `778:8712` already in it) ·
