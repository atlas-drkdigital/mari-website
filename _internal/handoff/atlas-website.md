...
`_internal/SCHEMA-SPECS.md` (🟡 draft / 🟢 approved / 🔵 validated-at-scale). Deliberately NOT created in the
...
- [ ] **When Mari's boat fields reach 🔵 validated in `_internal/SCHEMA-SPECS.md`:** create
...
`_internal/PAGE-SPECS.md`. FAQ page + blog list/post + simple page are DRK-wide (queued in drk-website.md);
