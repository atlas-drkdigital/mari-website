# _QA-CHECKLIST.md — for external QA (someone other than Adinda/Claude)

Companion to `_SCHEMA-SPECS.md` (field approval) and `_CONTENT-STATUS.md` (real vs. placeholder
...
- [ ] **ADINDA + SERGE — is Studio's delete-blocking dialog clear enough? (2026-07-23, parked by
      ...
      education (entry added to _OWNER-HANDBOOK.md). Detail: _PAGE-SPECS.md cross-cutting notes.
...
- [ ] **ADINDA — confirm the recovered boat `slug` is `mari` (i.e. `/boat/mari`) — 2026-07-17.** It didn't
      ...
      a redirect later. **Do this before the boat route ships.** Detail: `_CONTENT-STATUS.md`.
      ...
      `_CONTENT-STATUS.md`'s `gallery` row. Not a QA judgement call.)_
...
- [ ] **FAQ answer content — needs a real read-through (not a schema question).** The answers were re-seeded
      ...
      was last verified 2026-06-09 — see the ⚠️ block in `_CONTENT-STATUS.md`; verify with Serge before
